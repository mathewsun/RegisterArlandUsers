...
namespace ConsoleApp1
{
    class Program
    {
        ...
        {
            int currentPosition = 2766;

            while (currentPosition < 20000)
            {
                ...
                for (; currentPosition < 20000; currentPosition++)
                {
                    string userName = userNameStart + currentPosition;
                    ...
                    try
                    {
                        ...
                        {
                            Console.WriteLine($"{currentPosition}. Register user {userName}.");
                        }
                    }
                    catch (Exception ex)
                    {
